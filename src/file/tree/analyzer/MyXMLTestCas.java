...
public class MyXMLTestCas {
    ...
    public void testIdentical() throws Exception {
        ...
        Diff md = new Diff(myControlXML, myTestXML);
    }
    ...
    */
    ...
    private void assertXpathEvaluatesTo(String x, String jvmlatestyes, String myJavaFlavours) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private void assertXpathEvaluatesTo(String item_One, String htmlbodyliid1, Document wellFormedDocument) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private void assertNodeTestPasses(String testXML, CountingNodeTester countingNodeTester, short TEXT_NODE) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private void assertNodeTestPasses(NodeTest nodeTest, FibonacciNodeTester fibonacciNodeTester, short[] s, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private void assertXMLEqual(String comparing_test_xml_to_control_xml, String myControlXML, String myTestXML) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
